...
from app.agents.autogen_agents.tools.autogen.rag import create_graph_rag_search_tool, create_literature_review_tool
...
class GraphRAGAgentChat(BaseChatAgent):
    ...
    * If there are tool calls, they will also be executed right away before returning the handoff.
    ...
    async def on_messages_stream(
        ...
        # result = await self.generate_rag_response(self._model_context)
